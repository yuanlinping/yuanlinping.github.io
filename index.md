...
My research interests lie at the intersection of virtual/augmented reality (VR/AR), human-computer interaction (HCI), and data visualization (VIS). My research aims to enable humans to interact efficiently across physical, virtual, and hybrid 3D environments, empowered by immersive devices and artificial intelligence in the era of spatial computing. I design and develop algorithms, interactive tools, and visualizations for 1) creativity in building worlds, 2) data analysis in giving the world meaning, and 3) space activities that use the world for human benefit.
